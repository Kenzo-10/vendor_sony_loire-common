...
ifneq ($(filter suzu kugo blanc,$(TARGET_DEVICE)),)
...
include $(CLEAR_VARS)
LOCAL_MODULE := libta_drm_ext
LOCAL_MODULE_OWNER := sony
LOCAL_SRC_FILES_64 := proprietary/vendor/lib64/libta_drm_ext.so
LOCAL_SRC_FILES_32 := proprietary/vendor/lib/libta_drm_ext.so
LOCAL_MULTILIB := both
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_SUFFIX := .so
